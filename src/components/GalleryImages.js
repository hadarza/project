...
function GalleryImages() {
    return (
        <div className='relative flex justify-center z-10'>
          ...
          <button className="bg-yellow-500 font-secular absolute bottom-48 md:bottom-16 sm:bottom-0 px-8 py-4 rounded-md text-xl border-indigo-900 border-4 text-center cursor-pointer">התחל</button>
        </div>
    )
}
